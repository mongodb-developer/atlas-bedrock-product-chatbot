...
Repository for the AWS Bedrock and MongoDB Vector search [workshop](https://mongodb-developer.github.io/atlas-bedrock-crime-story-workshop/). Please make sure to complete all backend steps.
